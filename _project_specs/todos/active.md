...
3. **~~ADR-0020's fixture matrix~~ SHIPPED 2026-08-10.** 29 cases, 7 lucky-correct **pairs**, scored
   ...
   distinguish one** — qwen 7/7 pairs, `regex_match` 0/7. The sharp number is that the regex is
   right on **12 of 17 rows (~70%)** and earns **zero** pair credit; row-level accuracy would have
   called it competent. **CAVEAT, measured: the same classifier scores P=0.32/R=0.53 on the 114-turn
